...
import { UploadActionComponent } from './components/project-map/context-menu/actions/upload-action/upload-action.component';
...
import { UploadComponent } from './components/project-map/node-editors/uploader/upload.component';
