...
describe('ProjectService', () => {
  ...
  it('should get the project', () => {
    ...
    const req = httpTestingController.expectOne('http://ec2-13-233-160-96.ap-south-1.compute.amazonaws.com:3081/v2/projects/myproject');
  ...
  it('should open the project', () => {
    ...
    const req = httpTestingController.expectOne('http://ec2-13-233-160-96.ap-south-1.compute.amazonaws.com:3081/v2/projects/myproject/open');
  ...
  it('should close the project', () => {
    ...
    const req = httpTestingController.expectOne('http://ec2-13-233-160-96.ap-south-1.compute.amazonaws.com:3081/v2/projects/myproject/close');
    expect(req.request.method).toEqual('POST');
    expect(req.request.body).toEqual({});
  });
  ...
  it('should list projects', () => {
    ...
    const req = httpTestingController.expectOne('http://ec2-13-233-160-96.ap-south-1.compute.amazonaws.com:3081/v2/projects');
    expect(req.request.method).toEqual('GET');
  });
  ...
  it('should get nodes of project', () => {
    ...
    const req = httpTestingController.expectOne('http://ec2-13-233-160-96.ap-south-1.compute.amazonaws.com:3081/v2/projects/myproject/nodes');
    expect(req.request.method).toEqual('GET');
  });
  ...
  it('should get links of project', () => {
    ...
    const req = httpTestingController.expectOne('http://ec2-13-233-160-96.ap-south-1.compute.amazonaws.com:3081/v2/projects/myproject/links');
    expect(req.request.method).toEqual('GET');
  });
  ...
  it('should get drawings of project', () => {
    ...
    const req = httpTestingController.expectOne('http://ec2-13-233-160-96.ap-south-1.compute.amazonaws.com:3081/v2/projects/myproject/drawings');
    expect(req.request.method).toEqual('GET');
  });
  ...
  it('should duplicate the project', () => {
    ...
    const req = httpTestingController.expectOne('http://ec2-13-233-160-96.ap-south-1.compute.amazonaws.com:3081/v2/projects/projectId/duplicate');
    expect(req.request.method).toEqual('POST');
  });
