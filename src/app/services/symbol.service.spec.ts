...
describe('SymbolService', () => {
  ...
  it('should list symbols', inject([SymbolService], (service: SymbolService) => {
    ...
    const req = httpTestingController.expectOne('http://ec2-13-233-160-96.ap-south-1.compute.amazonaws.com:3081/v2/symbols');
  ...
  it('should get raw symbol', inject([SymbolService], (service: SymbolService) => {
    ...
    const req = httpTestingController.expectOne('http://ec2-13-233-160-96.ap-south-1.compute.amazonaws.com:3081/v2/symbols/:my/tested.png/raw');
    expect(req.request.method).toEqual('GET');
  }));
