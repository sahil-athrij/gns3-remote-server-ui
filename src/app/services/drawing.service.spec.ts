...
describe('DrawingService', () => {
  ...
  it('should updatePosition of drawing', inject([DrawingService], (service: DrawingService) => {
    ...
    const req = httpTestingController.expectOne('https://icsaa.in:3081/v2/projects/myproject/drawings/id');
  ...
  it('should duplicate drawing', inject([DrawingService], (service: DrawingService) => {
    ...
    const req = httpTestingController.expectOne(`https://icsaa.in:3081/v2/projects/${drawing.project_id}/drawings`);
