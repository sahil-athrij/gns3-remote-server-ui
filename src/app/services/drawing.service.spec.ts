...
describe('DrawingService', () => {
  ...
  it('should updatePosition of drawing', inject([DrawingService], (service: DrawingService) => {
    ...
    const req = httpTestingController.expectOne('https://ec2-13-233-160-96.ap-south-1.compute.amazonaws.com:3081/v2/projects/myproject/drawings/id');
  ...
  it('should duplicate drawing', inject([DrawingService], (service: DrawingService) => {
    ...
    const req = httpTestingController.expectOne(`https://ec2-13-233-160-96.ap-south-1.compute.amazonaws.com:3081/v2/projects/${drawing.project_id}/drawings`);
